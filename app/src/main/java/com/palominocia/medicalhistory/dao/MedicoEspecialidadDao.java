...
public class MedicoEspecialidadDao extends AbstractDao<MedicoEspecialidad, Void> {
    ...
    public static class Properties {
        ...
        public final static Property CodigoEspecialidad = new Property(2, Long.class, "codigoEspecialidad", false, "CODIGO_ESPECIALIDAD");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MEDICO_ESPECIALIDAD\" (" + //
                ...
                "\"CODIGO_ESPECIALIDAD\" INTEGER);"); // 2: codigoEspecialidad
    }
